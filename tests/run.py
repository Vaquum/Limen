...
from tests.test_feature_library_the_lab_surface import test_calendar_gaps_add_half_year_and_session_flags
from tests.test_feature_library_the_lab_surface import test_microstructure_features_match_the_lab_formulas
from tests.test_feature_library_the_lab_surface import test_rolling_zscore_supports_transforms_and_zero_std_nulls
from tests.test_feature_library_the_lab_surface import test_structural_correlation_and_volatility_helpers
from tests.test_feature_library_the_lab_surface import test_structural_rolling_features_match_the_lab_formulas
...
tests = [
    ...
    test_calendar_gaps_add_half_year_and_session_flags,
    test_microstructure_features_match_the_lab_formulas,
    test_rolling_zscore_supports_transforms_and_zero_std_nulls,
    test_structural_correlation_and_volatility_helpers,
    test_structural_rolling_features_match_the_lab_formulas,

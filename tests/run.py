...
from tests.test_metrics_and_log_helpers import test_long_flat_strategy_rejects_invalid_notional_rate
...
tests = [
    ...
    test_long_flat_strategy_rejects_invalid_notional_rate,

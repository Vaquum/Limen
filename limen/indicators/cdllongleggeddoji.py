...
def _cdllongleggeddoji_impl(
    ...
    while i < n:
        ...
        if real_body <= body_doji_avg and (lower_shadow > shadow_long_avg or upper_shadow > shadow_long_avg):
            out[i] = 100

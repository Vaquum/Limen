...
CDLONNECK_BODY_LONG_AVG_PERIOD = 10
CDLONNECK_BODY_LONG_PERIOD_TOTAL = 0.0
CDLONNECK_EQUAL_AVG_PERIOD = 5
CDLONNECK_EQUAL_FACTOR = 0.05
CDLONNECK_EQUAL_PERIOD_TOTAL = 0.0
...
def _cdlonneck_impl(
    ...
    equal_avg_period = CDLONNECK_EQUAL_AVG_PERIOD
    equal_factor = CDLONNECK_EQUAL_FACTOR
    body_long_avg_period = CDLONNECK_BODY_LONG_AVG_PERIOD
    ...
    equal_period_total = CDLONNECK_EQUAL_PERIOD_TOTAL
    body_long_period_total = CDLONNECK_BODY_LONG_PERIOD_TOTAL

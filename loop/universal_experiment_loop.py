...
class UniversalExperimentLoop:
    ...
    def run(self,
        ...
        self.experiment_confusion_metrics = self.log.experiment_confusion_metrics('price_change')
        self.experiment_backtest_results = self.log.experiment_backtest_results()
